...
export const SUBJECTS: Subject[] = [
  { id: 'apcalcbc',  name: 'Calculus BC',   cat: 'STEM',      level: 'AP' },
  { id: 'apcalcab',  name: 'Calculus AB',   cat: 'STEM',      level: 'AP' },
  { id: 'apphysc',   name: 'Physics C',     cat: 'STEM',      level: 'AP' },
  { id: 'apphys1',   name: 'Physics 1',     cat: 'STEM',      level: 'AP' },
  { id: 'apchem',    name: 'Chemistry',     cat: 'STEM',      level: 'AP' },
  { id: 'apbio',     name: 'Biology',       cat: 'STEM',      level: 'AP' },
  { id: 'satmath',   name: 'SAT Math',      cat: 'Test Prep', level: 'High School' },
  { id: 'satverb',   name: 'SAT Verbal',    cat: 'Test Prep', level: 'High School' },
  { id: 'actmath',   name: 'ACT Math',      cat: 'Test Prep', level: 'High School' },
  { id: 'mcat',      name: 'MCAT',          cat: 'Test Prep', level: 'College' },
  { id: 'apstat',    name: 'Statistics',    cat: 'STEM',      level: 'AP' },
  { id: 'algii',     name: 'Algebra II',    cat: 'STEM',      level: 'High School' },
  { id: 'apenglang', name: 'English Lang',  cat: 'Humanities', level: 'AP' },
  { id: 'apushist',  name: 'US History',    cat: 'Humanities', level: 'AP' },
  { id: 'spanish',   name: 'Spanish I',       cat: 'Languages',  level: 'High School' },
  { id: 'french',    name: 'French I',        cat: 'Languages',  level: 'High School' },
  { id: 'writing',   name: 'Creative Writing', cat: 'Humanities', level: 'High School' },
];
...
export const TUTORS: Tutor[] = [
  {
    ...
    isPaused: false, totalAvailabilityHours: 20, schedulingExceptions: [], availabilityRequests: [],
  },
  {
    ...
    isPaused: false, totalAvailabilityHours: 12, schedulingExceptions: [], availabilityRequests: [],
  },
  {
  ...
  },
  {
    ...
    isPaused: false, totalAvailabilityHours: 10, schedulingExceptions: [], availabilityRequests: [],
  },
  {
    ...
    isPaused: false, totalAvailabilityHours: 16, schedulingExceptions: [], availabilityRequests: [],
  },
  {
  ...
  },
  {
    ...
    isPaused: false, totalAvailabilityHours: 14, schedulingExceptions: [], availabilityRequests: [],
  },
];
...
export const TUTOR_PROPOSALS: TutorProposal[] = [
    ...
    scheduleNotes: 'Mon/Wed evenings 5–8pm work best. Could stretch to 8:30pm on Wednesdays.', sessionDurationMinutes: 60, sessionsPerWeek: 1 },
  {
    ...
    notes: '## Background\n\nJackson is a senior taking AP Physics for the first time. He\'s nervous about mechanics and needs foundational support.\n\n## Focus areas\n\n- Newton\'s laws and free body diagrams\n- Kinematics and projectile motion\n- Energy and momentum\n\nParent requests weekly progress updates.',
