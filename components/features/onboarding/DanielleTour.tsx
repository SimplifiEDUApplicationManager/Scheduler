...
const STEPS: Step[] = [
  ...
  },
  {
    ...
    body: "Click and drag within the dashed \"Student available\" windows to paint the times you're free to tutor. You need at least one block that's long enough for a session.",
    cta: 'Next',
    waitForEvent: true,
    hideBack: true,
  },
  {
    ...
    body: "Click \"Confirm availability\" to send your available times to the coordinator.",
    cta: 'Next',
    waitForEvent: true,
    placement: 'bottom-left',
    hideBack: true,
  },
  {
    ...
    pose: 'wave',
    title: 'Nice work! 🎉',
    body: "You just walked through the complete accept flow! Your availability is sent to the coordinator, who shares your profile with the family. If they approve, the coordinator schedules the sessions within the times you provided. Let's continue to Settings.",
    cta: 'Continue',
  },
  // ── Settings page ──────────────────────────────────────────────────────
  {
    ...
    pose: 'point',
    title: 'Capacity',
    body: "Set your maximum weekly hours here. Coordinators use this to decide how many sessions to route to you.",
    cta: 'Next',
  },
  {
    key: 'set-subjects',
